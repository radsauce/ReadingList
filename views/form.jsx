...
const Form = props =>
  <form>
    ...
    <div className='form-group'>
      <label htmlFor='cpage'>Current Page Number</label>
      <input type='number' className='form-control' id='cpage' placeholder={props.cpage ? '' : '51'} value={props.cpage ? props.cpage : ''} />
    </div>
